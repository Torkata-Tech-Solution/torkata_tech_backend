...
@section('content')
    <div id="kt_content_container" class=" container-xxl ">
        <form id="kt_portfolio_add_form" class="form d-flex flex-column flex-lg-row"
            action="{{ route('back.portfolio.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="text-muted fs-7 mt-3">
                            Upload multiple gambar untuk galeri portfolio. Maksimal 10 file dengan ekstensi .png, .jpg, .jpeg
                        </div>
                ...
                <div class="card card-flush py-4">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <div class="rounded-circle bg-success w-15px h-15px" id="kt_portfolio_add_status">
                            </div>
                        </div>
                    </div>
                    <div class="card-body pt-0">
                        <select name="status" class="form-select mb-2" data-control="select2" data-hide-search="true"
                            data-placeholder="Select an option" id="kt_portfolio_add_status_select" required>
                            <option></option>
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <textarea name="description" class="form-control mb-2" rows="3" placeholder="Deskripsi singkat portfolio" required>{{ old('description') }}</textarea>
                            @error('description')
                                <div class="text-danger fs-7">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-10">
                            ...
                            <div id="quill_content" name="kt_portfolio_add_description" class="min-h-400px mb-2">
                                {!! old('content') !!}
                            </div>
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('back.portfolio.index') }}" id="kt_portfolio_add_cancel"
                        class="btn btn-light me-5">Batal</a>
                    <button type="submit" class="btn btn-primary">
                        <span class="indicator-label">Simpan Portfolio</span>
                    </button>
                </div>
            </div>
            <!--end::Main column-->
